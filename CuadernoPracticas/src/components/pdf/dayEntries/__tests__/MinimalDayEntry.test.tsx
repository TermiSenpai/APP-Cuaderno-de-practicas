...
import { MinimalDayEntry } from "../MinimalDayEntry";
import type { Dia, PDFColors } from "../../../../core/models/types";

describe("MinimalDayEntry", () => {
  ...
  it("should render without errors", () => {
    expect(() => {
      MinimalDayEntry({ dia: testDia, colors: testColors, horasDefault: 8 });
    }).not.toThrow();
  });

  it("should accept dia prop", () => {
    const result = MinimalDayEntry({
      dia: testDia,
      colors: testColors,
      horasDefault: 8,
    });
  ...
  it("should use provided colors", () => {
    ...
    expect(() => {
      MinimalDayEntry({ dia: testDia, colors: customColors, horasDefault: 8 });
    }).not.toThrow();
  });
