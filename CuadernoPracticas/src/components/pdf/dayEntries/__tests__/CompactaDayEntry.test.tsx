...
import { CompactaDayEntry } from "../CompactaDayEntry";
import type { Dia, PDFColors } from "../../../../core/models/types";

describe("CompactaDayEntry", () => {
  ...
  it("should render without errors", () => {
    expect(() => {
      CompactaDayEntry({ dia: testDia, colors: testColors, horasDefault: 8 });
    }).not.toThrow();
  });

  it("should accept dia prop", () => {
    const result = CompactaDayEntry({
      dia: testDia,
      colors: testColors,
      horasDefault: 8,
    });
  ...
  it("should use provided colors", () => {
    ...
    expect(() => {
      CompactaDayEntry({ dia: testDia, colors: customColors, horasDefault: 8 });
    }).not.toThrow();
  });
