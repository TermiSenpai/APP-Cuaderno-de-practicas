...
describe("MinimalTemplate", () => {
  ...
  it("should render without errors", async () => {
    expect(() => {
      MinimalTemplate(testOptions);
    }).not.toThrow();
  });

  it("should accept config and dias props", () => {
    const result = MinimalTemplate(testOptions);
  ...
  it("should handle multiple dias", () => {
    ...
    expect(() => {
      MinimalTemplate(multipleDaysOptions);
    }).not.toThrow();
  });
