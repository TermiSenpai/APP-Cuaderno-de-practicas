...
import { ProfesionalTemplate } from "../ProfesionalTemplate";
...
describe("ProfesionalTemplate", () => {
  ...
  it("should render without errors", async () => {
    expect(() => {
      ProfesionalTemplate(testOptions);
    }).not.toThrow();
  });

  it("should accept config and dias props", () => {
    const result = ProfesionalTemplate(testOptions);
  ...
  it("should handle empty dias array", () => {
    ...
    expect(() => {
      ProfesionalTemplate(emptyOptions);
    }).not.toThrow();
  });
  ...
  it("should handle multiple dias", () => {
    ...
    expect(() => {
      ProfesionalTemplate(multipleDaysOptions);
    }).not.toThrow();
  });
  ...
  it("should use provided colors", () => {
    ...
    expect(() => {
      ProfesionalTemplate(customOptions);
    }).not.toThrow();
  });
});
