...
describe("ClasicaTemplate", () => {
  ...
  it("should render without errors", async () => {
    expect(() => {
      ClasicaTemplate(testOptions);
    }).not.toThrow();
  });

  it("should accept config and dias props", () => {
    const result = ClasicaTemplate(testOptions);
  ...
  it("should handle multiple dias", () => {
    ...
    expect(() => {
      ClasicaTemplate(multipleDaysOptions);
    }).not.toThrow();
  });
